...
var mUpgrades = [
	...
	new object(	/*10*/
		...
		150,"skill",
		"Add a second Worker",
		"show('gW1');show('mU11'); game.bMoneyRate += 0.01/30;",
		"+0.01$/s"
	),
	...
	new object(	/*11*/
		...
		200,"skill",
		"Add a third Worker",
		"show('gW2');show('mU12'); game.bMoneyRate += 0.01/30;",
		"+0.01$/s"
	),
	...
	new object(	/*12*/
		...
		300,"skill",
		"Add a forth Worker",
		"show('gW3');show('mU13'); game.bMoneyRate += 0.01/30;",
		"+0.01$/s"
	),
	...
	new object(	/*13*/
		...
		400,"skill",
		"Add a fifth Worker",
		"show('gW4');show('mU14'); game.bMoneyRate += 0.01/30;",
		"+0.01$/s"
	),
	...
	new object(	/*14*/
		...
		500,"skill",
		"Add a sixth Worker",
		"show('gW5');show('mU15'); game.bMoneyRate += 0.01/30;",
		"+0.01$/s"
	),
	...
	new object(	/*15*/
		...
		"show('gW6');show('mU16'); game.bMoneyRate += 0.01/30;",
		"0.01$/s"
	),
	...
	new object(	/*16*/
		...
		"show('gW7');show('mU17'); game.bMoneyRate += 0.01/30;",
		"0.01$/s"
	),
